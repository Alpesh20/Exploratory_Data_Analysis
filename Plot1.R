...
png(filename = './project/plot1.png', width = 480, height = 480, units='px')
hist(as.numeric(subdata2$Global_active_power), col="Red", main="Global Active Power", xlab="Global Active power (kilowatts)", ylab="Frequency")
dev.off()
