...
png(filename = './project/plot3.png', width = 480, height = 480, units='px')
plot(subdata2$DateTime, subdata2$Sub_metering_1, xlab = '', ylab = 'Energy sub metering', type = 'l', ylim=c(0,40))
